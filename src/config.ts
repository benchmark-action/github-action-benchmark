...
export type ToolType = 'cargo' | 'criterion' | 'go' | 'benchmarkjs' | 'pytest' | 'googlecpp' | 'catch2';
...
export const VALID_TOOLS: ToolType[] = ['cargo', 'criterion', 'go', 'benchmarkjs', 'pytest', 'googlecpp', 'catch2'];
const RE_UINT = /^\d+$/;
