...
function annVal(b: BenchmarkResult): string {
...
function buildAnnotation(benchName: string, curSuite: Benchmark, prevSuite: Benchmark): string {
    const lines = [
        `Benchmark ${benchName}`,
        '',
...
function handleAnnotation(benchName: string, curSuite: Benchmark, prevSuite: Benchmark, config: Config) {
