        ...
        const normalCases: Array<{
            ...
            },
            {
                ...
                error: [
                    ...
                    '',
                    '| Benchmark suite | Best | Previous: prev commit id | Current: current commit id | Ratio |',
                    '|-|-|-|-|-|',
                    '| `bench_fib_10` | `100` ns/iter (`± 20`) | `100` ns/iter (`± 20`) | `210` ns/iter (`± 20`) | `2.10` |',
                    '| `bench_fib_20` | `10000` ns/iter (`± 20`) | `10000` ns/iter (`± 20`) | `25000` ns/iter (`± 20`) | `2.50` |',
                    '',
            ...
            {
                it: 'raises an alert when exceeding threshold 2.0 and detects best benchmark',
                config: defaultCfg,
                data: {
                    lastUpdate,
                    repoUrl,
                    entries: {
                        'Test benchmark': [
                            {
                                commit: commit('old commit id'),
                                date: lastUpdate - 2000,
                                tool: 'go',
                                benches: [bench('bench_fib_10', 50), bench('bench_fib_20', 5000)],
                            },
                            {
                                commit: commit('prev commit id'),
                                date: lastUpdate - 1000,
                ...
                error: [
                    ...
                    '| Benchmark suite | Best | Previous: prev commit id | Current: current commit id | Ratio |',
                    '|-|-|-|-|-|',
                    '| `bench_fib_10` | `50` ns/iter (`± 20`) | `100` ns/iter (`± 20`) | `210` ns/iter (`± 20`) | `2.10` |',
                    '| `bench_fib_20` | `5000` ns/iter (`± 20`) | `10000` ns/iter (`± 20`) | `25000` ns/iter (`± 20`) | `2.50` |',
                    '',
                    `This comment was automatically generated by [workflow](${serverUrl}/user/repo/actions?query=workflow%3AWorkflow%20name) using [github-action-benchmark](https://github.com/marketplace/actions/continuous-benchmark).`,
                    '',
                    'CC: @user',
            ...
            {
                it: 'raises an alert when exceeding threshold 2.0 and detects best benchmark with compare-with-best',
                config: { ...defaultCfg, compareWithBest: true },
                data: {
                    lastUpdate,
                    repoUrl,
                    entries: {
                ...
                error: [
                    ...
                    'Benchmark result of this commit is worse than the previous benchmark result exceeding threshold `2`.',
                    '',
                    '| Benchmark suite | Best | Previous: prev commit id | Current: current commit id | Ratio vs. Best |',
                    '|-|-|-|-|-|',
                    '| `bench_fib_10` | `50` ns/iter (`± 20`) | `100` ns/iter (`± 20`) | `210` ns/iter (`± 20`) | `4.20` |',
                    '| `bench_fib_20` | `5000` ns/iter (`± 20`) | `10000` ns/iter (`± 20`) | `25000` ns/iter (`± 20`) | `5` |',
                    '',
                    `This comment was automatically generated by [workflow](${serverUrl}/user/repo/actions?query=workflow%3AWorkflow%20name) using [github-action-benchmark](https://github.com/marketplace/actions/continuous-benchmark).`,
                    '',
                    'CC: @user',
            ...
            },
            {
                ...
                error: [
                    ...
                    '| Benchmark suite | Best | Previous: prev commit id | Current: current commit id | Ratio |',
                    '|-|-|-|-|-|',
                    '| `benchFib10` | `100` ops/sec (`+-20`) | `100` ops/sec (`+-20`) | `20` ops/sec (`+-20`) | `5` |',
                    '',
                    `This comment was automatically generated by [workflow](${serverUrl}/user/repo/actions?query=workflow%3AWorkflow%20name) using [github-action-benchmark](https://github.com/marketplace/actions/continuous-benchmark).`,
                    '',
                    'CC: @user',
            ...
            },
            {
                ...
                error: [
                    ...
                    '| Benchmark suite | Best | Previous: prev commit id | Current: current commit id | Ratio |',
                    '|-|-|-|-|-|',
                    '| `benchFib10` | `100` ops/sec (`+-20`) | `100` ops/sec (`+-20`) | `100` ops/sec (`+-20`) | `1` |',
                    '',
                    `This comment was automatically generated by [workflow](${serverUrl}/user/repo/actions?query=workflow%3AWorkflow%20name) using [github-action-benchmark](https://github.com/marketplace/actions/continuous-benchmark).`,
                    '',
                    'CC: @user',
            ...
            },
            {
                ...
                error: [
                    ...
                    '| Benchmark suite | Best | Previous: prev commit id | Current: current commit id | Ratio |',
                    '|-|-|-|-|-|',
                    '| `bench_fib_10` | `100` ns/iter (`± 20`) | `100` ns/iter (`± 20`) | `350` ns/iter (`± 20`) | `3.50` |',
                    '',
                    `This comment was automatically generated by [workflow](${serverUrl}/user/repo/actions?query=workflow%3AWorkflow%20name) using [github-action-benchmark](https://github.com/marketplace/actions/continuous-benchmark).`,
                    '',
                    'CC: @user',
