...
describe('extractResult()', function () {
    ...
    const normalCases: Array<{
        ...
        // TODO: Tackle single and multiple ndJSON inputs, perhaps a separate
        // test cases for those where outputs are huge?
        // {
